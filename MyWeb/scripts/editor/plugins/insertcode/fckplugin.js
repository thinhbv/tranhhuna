/*********************************************************************************************************/
/**
 * Insert Html Code(Code Syntax Highlighting And Run Html Code) Plugin for FCKeditor 
...
FCKCommands.RegisterCommand('InsertCode',new FCKDialogCommand( 'InsertCode', FCKLang["InsertCodeBtn"], FCKPlugins.Items['insertcode'].Path + 'fck_insertcode.html', 500, 450 ) ) ;
...
//语言 ，语言文字，代码，是否显示行号，是否折叠,是否显示语言名词,是否文本域显示,是否有运行按钮
FCKInsertCode.Add = function( lan,lantxt,txt,hh,zd,yy,wby,ys,cols,rows)
{
	...
	var InsertCode_Path = FCKConfig.PluginsPath + "insertcode/";
...
***/
/**
	 if(ys)tmpHtml +="<input type='button' value=' 运行代码 ' onclick=\"RunHTMLcode("+wbyName+");\"> ";
	 tmpHtml +="<input type='button' value=' 选择代码 ' onclick='SelectHTMLcode("+wbyName+")'> 提示:可以修改代码再运行.";
**/
/********
  if(ys){
  tmpHtml +="<input type='button' value='运行代码' onclick=\"runCode("+wbyName+");\" class=\"codebutton\"> <input type='button' value='复制代码' onclick=\"copyCode("+wbyName+");\" class=\"codebutton\"> <input type=\"button\" value=\"另存代码\" onclick=\"saveCode("+wbyName+")\"  class=\"codebutton\">&nbsp;提示:可以先修改代码后再运行. ";
}
********/

	
  if(ys){
  tmpHtml +="<input type='button' value='"+FCKLang["RunCode"]+"' onclick=\"runCode("+wbyName+");\" class=\"codebutton\"> <input type='button' value='"+FCKLang["CopyCode"]+"' onclick=\"copyCode("+wbyName+");\" class=\"codebutton\"> <input type=\"button\" value=\""+FCKLang["SaveCode"]+"\" onclick=\"saveCode("+wbyName+")\"  class=\"codebutton\">&nbsp;"+FCKLang["HelpMsg"]+"";
}

  tmpHtml +='\r\n<link href="' + InsertCode_Path + 'insertcode.css" type="text/css" rel="stylesheet"></link>';
  tmpHtml +='\r\n<script type="text/javascript" src="' + InsertCode_Path + 'excute.js"></script>';
  ...
  //alert(tmpHtml); 
	...
	if(zd){
	   tmpHtml += "<span class='zhedie' id='"+hitDiv+"' style='cursor:pointer' onclick=\"javascript:"+codeDiv+".style.display='none';"+hitDiv2+".style.display='';"+hitDiv+".style.display='none';\">"+FCKLang.DivHidden+"</span>";
	   tmpHtml += "<span class='zhedie' id='"+hitDiv2+"' style='cursor:pointer;display:none;' onclick=\"javascript:"+codeDiv+".style.display='';"+hitDiv+".style.display='';"+hitDiv2+".style.display='none';\">"+FCKLang.DivDisplay+"</span>";
	}
	...
	tmpHtml +='\r\n<link href="' + InsertCode_Path + 'insertcode.css" type="text/css" rel="stylesheet"></link>';
	tmpHtml +='\r\n<script language="javascript" src="' + InsertCode_Path + 'excute.js"></script>';
	coText.innerHTML=tmpHtml;
}
