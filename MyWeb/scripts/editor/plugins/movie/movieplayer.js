/*********************************************************************************************************/
/**
 * Movie Plugin For Fckeditor (Support: Lajox ; Email: lajox@19www.com)
 * version:  1.0.0
...
var flashPlayer = FCKConfig.PluginsPath + "movie/player_flv_maxi.swf"; 
...
function loadMovieSelection() {
	...
	ShowE('tdBrowse', FCKConfig.MediaBrowser);
	return oMovie;
}
