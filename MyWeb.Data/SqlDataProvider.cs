...
namespace MyWeb.Data
{
    ...
    public class SqlDataProvider
    {
		...
		/// </summary>
#if DEBUG
		static string strConStr = @"Data Source=THINHBV-PC\MSSQLSERVER2014;Initial Catalog=shareco1_tranhhuna;User ID=sa;Password=1qaz2wsx;Pooling=true;Max Pool Size=256;Min Pool Size=16;";
#else
